        ...
        <GridSystem>
          <Wrap pt={6} mb={5}>
            ...
            <Flow>
              ...
              <Text fontSize={1}>
                You should have a solid background in graphic design, a
                portfolio to back it up, and knowledge of what it takes to
                actually ship a quality product. We all have interests and
                skills outside of product design, though—including illustration,
                engineering, public speaking, and writing. Ideally you do, too.
                Tell us about it!
              </Text>
              <Text fontSize={1}>
                We’re not machines. We work a 35-hour work week, with time left
                over to for internal projects or learning a new skill. You’ll
                only be on one project at a time, so you can hone in on the
                right problems and give them the attention and care they
                deserve.
              </Text>
            </Flow>
          </Wrap>
          <Wrap gridColumn="1/-1" mb={5} overflowY="hidden">
            <Slider>
              <Image
                flex="0 0 500px"
                marginRight={3}
          ...
          <Wrap mb={5}>
            ...
            <Text mb={4} fontSize={2}>
              During interviews, we want to hear about your work as a whole:
              what you did, the thinking and research that went into it, and
              what you learned at the end. Then, tell us where you want to go.
              What do you want learn next? How do you want to grow?
            </Text>
            <Box
              as="ol"
              css={{
          ...
          <Wrap>
            <Box mt={5}>
              ...
              <Text mb={4} fontSize={2}>
                ...
                responsibility to influence teams, clients, and companies
                through research, creativity and collaboration. We’re looking
                for people who are ready to take charge, and ship quality
                products.
              </Text>
            </Box>
          </Wrap>
